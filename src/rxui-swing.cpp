#include "rxui-swing.h"

#include <tk.h>

TkRoot::TkRoot(void *container) : container{container}
{
    this->size = sizeof(TkRoot);
    this->name = "TkRoot";
}

void TkRoot::init(rxui::Root &self, void *props)
{
    new(&self) TkRoot(props);
}

void TkRoot::beginChildren()
{
